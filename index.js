...
const poolModule = readFileSync("./modules/pool.lua").toString();
const tokenModule = readFileSync("./modules/token.lua").toString();

const arweave = Arweave.init({});

const wallet = await arweave.wallets.generate();
const processId = "HNIsIdCJzUINPhAsnTOY-7XgYW2ZKEXqzKR9lNg7rG4";
